...
module.exports = class Embed extends Command {
  ...
  async run(message, args) {
    const ajuda = new MessageEmbed()
      ...
      .addField(`Embed Visualizer`, `Que tal testar sua embed antes de colocar na Iris? Assim você saberá se há erros ou não. Acesse ao site do [Embed Visualizer](https://leovoel.github.io/embed-visualizer/) e teste.`)
